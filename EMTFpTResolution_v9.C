...
//=Also, it looks into the peak at EMTF pT/RECO pT -1 from -1 ~ -0.7;
//=**************************************************************************************
void EMTFpTResolution_v9()
{
...
TFile myPlot("/afs/cern.ch/work/w/wshi/public/EMTFpTResolution/EMTFpTResolution_274440_443_v9_lxplus.root","RECREATE");
//TFile myPlot("~/Documents/EMTFpTResolution/EMTFpTResolution_274440_443_v9_local.root","RECREATE");
...
unexpected_peak_EMTF_modes->Write();
    ...
    myPlot.Close();
    cout<<"---------------"<<endl;
    cout<<"All plots saved in EMTFpTResolution_274440_443_v9_lxplus.root file!"<<endl;
