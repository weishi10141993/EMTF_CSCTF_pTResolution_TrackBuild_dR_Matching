...
void CSCTFpTResolution_v8()
{
    ...
    TFile myPlot("/afs/cern.ch/work/w/wshi/public/EMTFpTResolution/CSCTFpTResolution_274440_443_v8.root","RECREATE");
    ...
    myPlot.Close();
    cout<<"---------------"<<endl;
    cout<<"All plots saved in CSCTFpTResolution_274440_443_v8.root file!"<<endl;
