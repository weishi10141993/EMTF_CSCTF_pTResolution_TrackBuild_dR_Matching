...
//=****************************************************************
//void TrackBuild_v3(int run_lxplus=1, int run_Events=-1)
...
void TrackBuild_v3()
{
    ...
    */
    ...
    TH1F *RECO_eta_EMTF_mode_7_CSCTF_mode_15 = new TH1F("RECO eta when EMTF mode=7, CSCTF mode=15","CSCTF pT when EMTF mode=7, CSCTF mode=15",24,0,2.4);
    ...
    TH1F *RECO_eta_EMTF_mode_15_CSCTF_mode_7 = new TH1F("RECO eta when EMTF mode=15, CSCTF mode=7","CSCTF pT when EMTF mode=15, CSCTF mode=7",24,0,2.4);
    //pms 2
    ...
    TH1F *RECO_eta_EMTF_mode_11_CSCTF_mode_15 = new TH1F("RECO eta when EMTF mode=11, CSCTF mode=15","CSCTF pT when EMTF mode=11, CSCTF mode=15",24,0,2.4);
    ...
    TH1F *RECO_eta_EMTF_mode_15_CSCTF_mode_11 = new TH1F("RECO eta when EMTF mode=15, CSCTF mode=11","CSCTF pT when EMTF mode=15, CSCTF mode=11",24,0,2.4);
    //pms 3
    ...
    TH1F *RECO_eta_EMTF_mode_13_CSCTF_mode_15 = new TH1F("RECO eta when EMTF mode=13, CSCTF mode=15","CSCTF pT when EMTF mode=13, CSCTF mode=15",24,0,2.4);
    ...
    TH1F *RECO_eta_EMTF_mode_15_CSCTF_mode_13 = new TH1F("RECO eta when EMTF mode=15, CSCTF mode=13","CSCTF pT when EMTF mode=15, CSCTF mode=13",24,0,2.4);
    //pm 4
    ...
    TH1F *RECO_eta_EMTF_mode_14_CSCTF_mode_15 = new TH1F("RECO eta when EMTF mode=14, CSCTF mode=15","CSCTF pT when EMTF mode=14, CSCTF mode=15",24,0,2.4);
    ...
    TH1F *RECO_eta_EMTF_mode_15_CSCTF_mode_14 = new TH1F("RECO eta when EMTF mode=15, CSCTF mode=14","CSCTF pT when EMTF mode=15, CSCTF mode=14",24,0,2.4);
    ...
    */
            ...
            for(int itrk=0;itrk<TrkPt->size();itrk++){
                ...
                for(int kleg_trk=0;kleg_trk<Leg_TrkPt->size();kleg_trk++){
                    ...
                    if(trk_flag[itrk]==leg_trk_flag[kleg_trk] && itrk<8 && kleg_trk<8){
                        ...
                        double EMTF_Relative_Residual = EMTF_Residual/(1/trkPt[itrk]);
                        double CSCTF_Relative_Residual = CSCTF_Residual/(1/leg_trkPt[kleg_trk]);
    ...
    TFile myPlot("/afs/cern.ch/work/w/wshi/public/EMTFpTResolution/TrackBuild_v3_274440_443_lxplus.root","RECREATE");
    //TFile myPlot("~/Documents/EMTFpTResolution/TrackBuild_v3_274440_443_local.root","RECREATE");
     ...
     */
    //if(run_lxplus==1){
        cout<<"Save path:/afs/cern.ch/work/w/wshi/public/EMTFpTResolution/TrackBuild_v3_274440_443_lxplus.root"<<endl;
    //}
    //else if(run_lxplus==0){
        cout<<"Save path:~/Documents/EMTFpTResolution/TrackBuild_v3_274440_443_local.root"<<endl;
    //}
    //else{
      //  cout<<"Error: Fail to locate running machine!"<<endl;
    //}
