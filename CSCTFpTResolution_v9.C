...
void CSCTFpTResolution_v9()
{
        ...
        if(TrkPt->size()!=0 || RecoPt->size()!=0){
            ...
            while (matched_tracks != TrkPt->size() && matched_tracks != RecoPt->size()) {
                ...
                if(min_dR < 0.25 && trkBx[min_dR_itrk]==0){
                    ...
                    Double_t Relative_Residual = Residual/(1/trkPt[min_dR_itrk]);//this is actually csctf/reco - 1, as suggested by andrew;
    ...
    TFile myPlot("/afs/cern.ch/work/w/wshi/public/EMTFpTResolution/CSCTFpTResolution_274440_443_v9_lxplus.root","RECREATE");
    //TFile myPlot("~/Documents/EMTFpTResolution/CSCTFpTResolution_274440_443_v9_local.root","RECREATE");
    ...
    myPlot.Close();
    cout<<"---------------"<<endl;
    cout<<"All plots saved in CSCTFpTResolution_274440_443_v9_lxplus.root file!"<<endl;
